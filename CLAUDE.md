...
- Этап 2 (ingestion UK, 8 пилотных актов) — ✅ (schedules и исторические
  редакции — позже)
- Этап 3 (чанки-статьи, гибридный retrieval, RRF, reranker-слот, векторы
  voyage-law-2 на всём корпусе) — ✅
...
- KZ (adilet.zan.kz), Германия/Канада/ОАЭ, case law, cross-encoder — следующие
  сессии.
