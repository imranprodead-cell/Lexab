...

    {
      ...
      items: [
        ...
        },
        {
          ...
          a: {
            ru: 'Да. Бесплатный тариф даёт 20 ИИ-запросов, 3 документа и 100 МБ хранилища в месяц, а подключение Google Drive, OneDrive и Dropbox доступно на всех тарифах, включая его.',
            en: 'Yes. The free plan gives 20 AI requests, 3 documents and 100 MB of storage per month, and Google Drive, OneDrive and Dropbox connections are available on every plan, including it.',
            de: 'Ja. Der kostenlose Tarif bietet 20 KI-Anfragen, 3 Dokumente und 100 MB Speicher pro Monat; Google Drive, OneDrive und Dropbox lassen sich in allen Tarifen anbinden, auch in diesem.',
            ...
            kk: 'Иә. Тегін тариф айына 20 ЖИ сұрауын, 3 құжатты және 100 МБ қойманы береді, ал Google Drive, OneDrive және Dropbox қосу барлық тарифтерде, оның ішінде осында да, қолжетімді.',
            uz: 'Ha. Bepul tarif oyiga 20 ta AI soʻrovi, 3 ta hujjat va 100 MB xotira beradi, Google Drive, OneDrive va Dropbox ulash esa barcha tariflarda, shu jumladan unda ham mavjud.',
          },
        },
      ],
    },
